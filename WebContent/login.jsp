...
<body>
<div id="header">
    <div class="login_header_left"><img src="images/logo1.gif" alt="logo"/></div>
    ...
    <div class="login_main_mid">
        ...
        <form id="loginForm" action="doLogin" method="post">
            <dl class="login_content">
                <dt>昵称：</dt>
                <dd><input id="name" type="text" class="login_content_input" name="Username"/></dd>
            </dl>
            <dl class="login_content">
                <dt>密码：</dt>
                <dd><input id="pwd" type="password" class="login_content_input" name="Password"/></dd>
            </dl>
            <dl class="login_content">
                <dt></dt>
