		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					%>
					<c:set var="WIDtotal_amount" scope="request" value="${request.WIDtotal_amount}"/>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "当当网";
		//document.getElementById("WIDtotal_amount").value = "0.01";
		document.getElementById("WIDbody").value = "当当网"+sNow;
	}
	GetDateNow();
</script>
</html>