...
<div id="main">
    <div class="register_content">
        ...
        <div class="register_message">
            <form action="doRegist" method="post" id="myform">
                ...
                <dl class="register_row">
                    <dt>设置用户名：</dt>
                    <dd><input id="username" type="text" class="register_input" name="username"/></dd>
                ...
                <dl class="register_row">
                    <dt>所在地区：</dt>
                    <dd>
                        <select id="province" style="width:120px;" name="province">
                            <option>请选择省/城市</option>
                        </select>
                    </dd>
                    <dd>
                        <select id="city"  style="width:130px;" name="city">
