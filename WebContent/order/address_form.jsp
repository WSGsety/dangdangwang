...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
		  $('#fullAddress').blur(function(){
			...
			//1:判断地址是否为空
			    ...
			    //2:检测地址是否合法
			    var add_reg =/^[\u4e00-\u9fa5_0-9]{4,20}$/;
			    if(add_reg.test(fullAddress)){
		...
		$(function(){
		  $('#phone').blur(function(){
		    ...
		    //2:检测电话号码是否合法
		    var phone_reg =/^(0[0-9]{2,3}-?)?([0-9]{7,8})$/;
	...
	<body>
		...
		<div class="fill_message">
			...
			<form name="ctl00" method="post" action="order_ok.jsp" id="order_form">
				...
				<div class="login_in">
					...
					<a href="../doCart?action=Cart"><input id="btnClientRegister1" class="button_1" name="submit"
					type="button" value="取消" /></a>
				<a href="order_ok.jsp">
				<input id="btnClientRegister" class="button_1"
					type="submit" value="下一步"/></a><!--  onclick="return confirm('确认要购买吗？')" -->
				</div>
			</form>
		</div>
		<div id="footer">
