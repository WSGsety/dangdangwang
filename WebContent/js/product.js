...
$(function($){
    ...
    function getBigBookList(){
        ...
        $initContent.find(".product_storyList_content_right").find("ul").each(function(i,ele){
            ...
            content.push("<li class='detail'>"+$($li[0]).html()+"</li>");//书名
            ...
            /*content.push("<div>");
            content.push("<dl class='product_content_dd'>");
            content.push("<dd><input type='submit' id='queding' value='跳转'></input></dd>");
            content.push("<dd>页</dd>");
            content.push("<dd><input id='pagenumber' name='page' type='text' value='1' style='width:20px;'/></dd>");
            content.push("<dd>跳转到第</dd>");
            content.push("<dd><a href='doProduct?flag=up&pageNo=${pageNo}'><img src='images/next.gif' alt='ok'/></a></dd>");
            content.push("<dd>");
            content.push("<ul id='product_page'>");
            content.push("<c:forEach var='tt' begin='1' end='${sessionScope.pageCount }'>");
            content.push("<li><a href='doProduct?pageNo=${tt}' class='product_page'>${tt }</a></li>");
            content.push("</c:forEach>");
            content.push("</ul>");
            content.push("</dd>");
            content.push("<dd><a href='doProduct?flag=down&pageNo=${pageNo}'><img src='images/product_page_up.gif' alt='ok'/></a></dd>");
            content.push("</dl>");
            content.push("</div>");*/
