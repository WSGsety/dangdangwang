...
<div id="main">
    ...
    <div id="catList">
        ...
        <div class="book_sort">
                  ...
                  <ul id="menu_left_bold">
			        <%
			            CategoryDaoImpl cdi = new CategoryDaoImpl();
				  		ArrayList<Category> clist= cdi.checkCategory1();
				  		request.setAttribute("clist",clist);
				  	%>
				  	<c:forEach var="c" items="${clist}" begin="0" end="3">
						<a href="doProduct?catid=${c.catid}&action=nopaixu" target="_parent" class="bold">${c.name }</a>|
	            ...
	            <ul id="menu_left_bold">
			        <%
			            CategoryDaoImpl cdi1 = new CategoryDaoImpl();
				  		ArrayList<Category> clist1= cdi.checkCategory2();
				  		request.setAttribute("clist1",clist1);
				  	%>
				  	<c:forEach var="c" items="${clist1}" begin="0" end="3">
						<a href="doProduct?catid=${c.catid}&action=nopaixu">${c.name }</a>|
					</c:forEach>
		        </ul>
	        </div>
            ...
            <ul id="menu_left_bold">
        <%
            CategoryDaoImpl cdi2 = new CategoryDaoImpl();
	  		ArrayList<Category> clist2= cdi.checkCategory3();
	  		request.setAttribute("clist2",clist2);
	  	%>
	  	<c:forEach var="c" items="${clist2}" begin="0" end="3">
			<a href="doProduct?catid=${c.catid}&action=nopaixu">${c.name }</a>|
